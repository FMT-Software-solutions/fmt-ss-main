        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Empowering businesses with premium software solutions and expert training.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/free-apps" className="text-sm text-muted-foreground hover:text-foreground">
                  Free Apps
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/training/archive" className="text-sm text-muted-foreground hover:text-foreground">
                  Training Archive
                </Link>
              </li>
            </ul>
